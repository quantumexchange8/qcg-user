...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/getGroupTransactionMonths', [GeneralController::class, 'getGroupTransactionMonths'])->name('getGroupTransactionMonths');
    ...
    Route::prefix('rewards')->group(function () {
        ...
        Route::get('/viewAllPointHistory', [RewardController::class, 'viewAllPointHistory'])->name('rewards.viewAllPointHistory');
